                        ...
                        <ul class="list-unstyled w3ls-items">
                            ...
                            <li>
                                <div class="row mt-5">
                                    ...
                                    <div class="col-9">
                                        <h6>Email</h6>
                                        <a href="mailto:info@edokio.com">info@edokio.com</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="row mt-5">
                                    ...
                                    <div class="col-9">
                                        <h6>Become Edokio Coach</h6>
                                        <a href="mailto:info@edokio.com" class="">info@edokio.com</a>
                                    </div>
                                </div>
                            </li>
