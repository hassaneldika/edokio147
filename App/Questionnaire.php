		...
		<body>
			...
			<section id="storyboardBlue">
				<div class="jumbotron subhead" id="overview">
					<div class="container">
						<?php if ($allquestions[0]['direction'] == 'English' || $allquestions[0]['direction'] == 'english' || $allquestions[0]['direction'] == 'En' || $allquestions[0]['direction'] == 'en' || $allquestions[0]['direction'] == 'eng' || $allquestions[0]['direction'] == 'Eng') {
							$MyDirection = ' direction: ltr !important;    text-align: left !important;';
						} else {
							$MyDirection = ' direction: rtl !important;    text-align: right !important;';
						}
						?>
						<div class="row " style="<?php echo $MyDirection; ?>">
							<div class="span8">
			...
			<section id="maincontent">
				<div class="container ContainerHomePage">
					...
					<div class="row pad-row-laws " style="<?php echo $MyDirection; ?>">
