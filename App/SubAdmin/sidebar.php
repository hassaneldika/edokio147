	...
	<div class="sidebar-menu">
		...
		<div class="menu">
			<ul id="menu" >
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Courses</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
					<ul id="menu-academico-sub">
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span> Users</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="adduser.php">Add Users</a></li>
						<li id="menu-academico-avaliacoes"><a href="listofusers.php">List of Users</a></li>
