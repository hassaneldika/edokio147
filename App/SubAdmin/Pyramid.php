		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				if($_SESSION["userid"]==true) {
					...
					$conx = new Service;
					$conx->connect();
					$stmt = $conx->dbh->prepare("SELECT S.SessionName, COUNT(*) AS TotalRows FROM session S JOIN examgrades E ON E.sessionid = S.SessionId WHERE E.examstatus= 'P' GROUP BY S.SessionName");
					$stmt->execute();
