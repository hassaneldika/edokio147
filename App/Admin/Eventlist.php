											...
											<form action="editevent.php" method="post">
												<tr>
													...
													<td>
														...
														if($status=='0') { ?>
														<a class="btn bg-danger full-width text-white" onclick="confirmactivate(<?php echo $rows['EventId']; ?>)"> Activate </a>
														<?php }
														else if($status=='1') { ?>
														<a class="btn bg-success full-width text-white" onclick="confirmdeactivate(<?php echo $rows['EventId']; ?>)"> Deactivate </a>
														<?php } ?>
													</td>
													<td>
														<a class="btn btn-admin-delete text-white" onclick="confirmdelete(<?php echo $rows['EventId']; ?>)"> Delete </a>
													</td>
													<td>
