					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table width="100%" id="table" style="table-layout: fixed;width: 100%;">
								<thead>
									<tr>
										<th align="left" colspan="2">Presentation Name</th>
										<th align="left" colspan="1">Video Name</th>
										<th align="left" colspan="2">Youtube Link</th>
										<th align="left" colspan="2">Video Text</th>
										<th align="left" colspan="">Direction</th>
										<th align="left" colspan="2">PDF</th>
	...
	<script type="text/javascript">
		...
		function submitedit(id) {
			...
			$.ajax({
				...
				method:"POST",
				data:{action:action, videoname:videoname,VideoText:VideoText,youtube:youtube,direction:direction,PDF:PDF ,sessionid:sessionid},
				success:function(data){
