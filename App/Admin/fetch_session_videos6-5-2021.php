			...
			foreach($result as $row){
				...
				$output .= '
					<tr>
						...
						<td><input type="text" name="videoname" class="form-admin-input" value="'.$row['videoname'].'" id="videoname'.$row['SessionId'].'" required></td>
						<td><input type="text" name="youtube" class="form-admin-input" value="'.$row['youtube'].'" id="youtube'.$row['SessionId'].'" required></td>
						<td colspan="3" ><textarea id="VideoText'.$row['SessionId'].'"  class="form-admin-input" style="width: 100%;">"'.$row['VideoText'].'"</textarea>
						</td>
