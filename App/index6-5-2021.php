        ...
        <section class="about py-5">
            <div class="container py-md-5">
                <div class="about-w3ls-info text-center mx-auto">
                    ...
                    <p class="sub-tittle mt-3 mb-sm-5 mb-4">With an expertise in content creation in English, French, and Arabic, and a know-how in soft skills and vocational training, Edokio is the partner of choice of organizations wishing to enhance their business and workforce performance in a proven and cost-effective way.</p>
                    <a href="about.php" class="btn btn-primary submit">Read More</a>
                </div>
            </div>
        </section>
        <!-- //about -->
            ...
            <div class="container py-xl-5 py-lg-3">
                <div class="row">
                    <div class="col-lg-5 welcome-left">
                        ...
                        <p class="mt-4 pr-lg-5">Edokio empowers organizations and its workforce to achieve success in a cost-effective and engaging way through blended e-learning on soft & vocational skills <a href="about.php">Continue..</a></p>
                    </div>
