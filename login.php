...
if(isset($_GET["code"]))
{
 ...
 if(!isset($token['error']))
 {
  ...
  include_once "service.php";
                        $service = new Service();
                        $Admins = $service->ExternalUser($_SESSION['user_first_name'],$_SESSION['user_last_name'],$_SESSION['user_email_address'],$_SESSION['user_gender'],$_SESSION['user_image']);
                        //var_dump($Admins);
 }
}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 contact-right-wthree-info login">
                        ...
                        <form action="loginaction.php" method="POST">
                            <div align="right" class="form-group mt-4">
                                <label class="mb-2">كلمة المرور</label>
                                <input type="password" name="txtpassword" class="form-control" id="password1" placeholder="" required="">
                            </div>
                            <h6 align="right" class="my-3">الوصول محجوز للمستفيدين من البرامج</h6>
                            <button type="submit" name="loginsubmit" class="btn btn-primary submit mb-4">إرسال </button>
