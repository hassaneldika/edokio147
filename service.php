...
class Service{
    ...
    function account($username,$user_image,$user_email_address,$user_first_name,$user_last_name){
			
		$insertsql = "INSERT INTO account (username, user_image, user_email_address,user_first_name,user_last_name) VALUES('".$username."','".$user_image."','".$user_email_address."','".$user_first_name."','".$user_last_name."')";
				
				$insertstmt = $this->dbh->prepare($insertsql);
				$insertstmt->bindParam(":email",$user_email_address);
				$insertstmt->bindParam(":name",$username);
				$insertstmt->bindParam(":user_image",$user_image);
				$insertstmt->bindParam(":user_first_name",$user_first_name);
				$insertstmt->bindParam(":user_last_name",$user_last_name);
