...
$conx = new Service;
$conx->connect();
$sql = $conx->dbh->prepare("SELECT * FROM posts ORDER BY Id DESC;");
$sql->execute();
                        ...
                        <div class="card-body">
                            <?php if ($q['file_url'] != NULL) { ?>
                                ...
                                <div>
                                    ...
                                    <a href="viewPost.php?Id=<?php echo $q['Id'] ?>" class="btn btn-light" style="color: #fc636b;">اقرأ أكثر <span class="text-danger">&rarr;</span></a>
                                </div>
